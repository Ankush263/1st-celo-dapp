...
import { uploadDonateJSONtoIPFS, uploadFileToIPFS } from '../../../../utils/pinata';
      ...
      <div className={styles.page}>
        <div className={styles.head}>
          ...
          <Link href="/components/CELO-HACK/donate/MyDonations">
            <Button variant='contained'><span className="capitalize text-sm">Donation</span></Button>
          </Link>
        </div>
